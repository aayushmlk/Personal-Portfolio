    ...
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-2xl text-primary font-bold">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/aayushmlk", label: "GitHub" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/aayush-mallick-859094280/", label: "LinkedIn" },
                { icon: Facebook, href: "https://www.facebook.com/aayush.mlk", label: "Facebook" },
                { icon: Instagram, href: "https://www.instagram.com/aayush.mlk/", label: "Instagram" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
        ...
        <div className="mt-20 animate-fade-in animation-delay-600">
          <p className="text-2xl font-semibold text-primary mb-6 text-center">
